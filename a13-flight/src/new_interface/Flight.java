...
public class Flight extends JFrame {
	...
	public Flight() { // GUI Constructor
		...
		loyaltyIDNumber.setBounds(95, 149, 144, 22);
		contentPane.add(loyaltyIDNumber);

		add = new JButton("Add");
		add.setBounds(10, 265, 119, 23);
		contentPane.add(add);
		...
		remove.setBounds(140, 265, 119, 23);
		...
		update.setBounds(10, 299, 249, 23);
		...
		dialogBox.setBounds(269, 55, 573, 22);
		...
		scrollListEmployeeDataTable.setBounds(269, 85, 573, 306);
